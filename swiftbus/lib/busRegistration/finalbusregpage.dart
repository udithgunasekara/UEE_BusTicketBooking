      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text('Add images of bus No: ${widget.busDetails['busNo']} (Optional) Uploaded images will be help passengers to identify your bus easily.',
            ...
            ElevatedButton(
              ...
              child: Icon(
                ...
                color: _images.isEmpty || _isUploading? Colors.grey: Colors.green, // Keeps the arrow white
              ),
            ),
            SizedBox(height: 30),
            ElevatedButton(
